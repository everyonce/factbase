#!/usr/bin/env bash
# Create 30 isolated v2 eval tasks for Sonnet model
set -euo pipefail
...
PROJECT_ID=2
BUCKET_ID=4
KB_PATH="/Volumes/dev/factbase-test/prompt-eval-v2"
RESULTS_FILE="/Users/daniel/work/factbase/docs/v2-results-sonnet.md"
...
Model: ${MODEL}"
  ...
  local full_title="[kb:${KB_PATH}] Step ${step}/30 (sonnet) — ${title}"
