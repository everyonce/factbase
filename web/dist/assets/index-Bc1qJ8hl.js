...
`).map((s,n)=>{const a=n+1,i=t!==null&&a===t;return`
  ...
  `}function _e(){if(!p)return;const e=p.querySelector("#preview-panel-content");e&&(e.innerHTML=Xe(),Ye(),h.highlightLine!==null&&!h.loading&&setTimeout(()=>{const t=document.getElementById("highlighted-line");t==null||t.scrollIntoView({behavior:"smooth",block:"center"})},100))}function Ye(){var e,t;(e=document.getElementById("preview-close-btn"))==null||e.addEventListener("click",fe),(t=document.getElementById("preview-close-error"))==null||t.addEventListener("click",fe),document.querySelectorAll(".preview-link-btn").forEach(r=>{r.addEventListener("click",s=>{const n=s.currentTarget.dataset.docId;n&&G(n)})})}async function Ft(e){h.loading=!0,h.error=null,h.document=null,_e();try{const t=await k.getDocument(e),r=await k.getDocumentLinks(e);h.document={...t,links_to:r.links_to,linked_from:r.linked_from}}catch(t){t instanceof C?h.error=t.message:h.error="Failed to load document"}finally{h.loading=!1,_e()}}function G(e,t){h.highlightLine=t??null,K||(Ut(),K=!0),Ft(e)}function fe(){p&&(p.classList.add("translate-x-full"),setTimeout(()=>{p==null||p.remove(),p=null},300)),K=!1,h.document=null,h.error=null,h.highlightLine=null}function Ut(){p==null||p.remove(),p=document.createElement("div"),p.id="document-preview-panel",p.className=`
  ...
  `}const y={loading:!1,error:null,doc1:null,doc2:null};let J=!1,x=null,X=null,Y=null;function _(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}function ye(e){const t=e.split(`
...
`))||[];return`
  ...
  `}function Re(){if(!x)return;const e=x.querySelector("#merge-preview-content");e&&(e.innerHTML=nt(),at())}function at(){var e,t,r,s;(e=document.getElementById("merge-preview-close-btn"))==null||e.addEventListener("click",se),(t=document.getElementById("merge-preview-close-error"))==null||t.addEventListener("click",se),(r=document.getElementById("merge-preview-dismiss-btn"))==null||r.addEventListener("click",()=>{se()}),(s=document.getElementById("merge-preview-approve-btn"))==null||s.addEventListener("click",()=>{const n=`factbase organize merge ${X} ${Y}`;navigator.clipboard.writeText(n).then(()=>{const a=document.getElementById("merge-preview-approve-btn");a&&(a.textContent="Copied!",setTimeout(()=>{a.textContent="Copy Command"},2e3))}).catch(()=>{alert(`Run: ${n}`)})})}async function cr(e,t){y.loading=!0,y.error=null,y.doc1=null,y.doc2=null,Re();try{const[r,s]=await Promise.all([k.getDocument(e),k.getDocument(t)]);y.doc1=r,y.doc2=s}catch(r){r instanceof C?y.error=r.message:y.error="Failed to load documents"}finally{y.loading=!1,Re()}}function ur(e,t){X=e,Y=t,J||(gr(),J=!0),cr(e,t)}function se(){x&&(x.classList.add("translate-x-full"),setTimeout(()=>{x==null||x.remove(),x=null},300)),J=!1,y.doc1=null,y.doc2=null,y.error=null,X=null,Y=null}function gr(){x==null||x.remove(),x=document.createElement("div"),x.id="merge-preview-panel",x.className=`
  ...
  `,document.body.appendChild(x),requestAnimationFrame(()=>{x==null||x.classList.remove("translate-x-full")}),at();const e=t=>{t.key==="Escape"&&J&&se()};document.addEventListener("keydown",e),x._cleanup=()=>{document.removeEventListener("keydown",e)}}function mr(){if(x){const e=x._cleanup;e&&e(),x.remove(),x=null}J=!1,y.doc1=null,y.doc2=null,y.error=null,X=null,Y=null}const b={loading:!1,error:null,doc:null,sections:[]};let V=!1,f=null,Z=null;function H(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}function je(e){const t=e.split(`
...
`).length>5;return`
  ...
  `}function it(){if(b.loading)return`
    ...
    <div class="flex flex-col h-full">
      ...
      <div class="flex-1 overflow-auto p-4">
        <div class="space-y-3">
          ${b.sections.map((r,s)=>xr(r,s)).join("")}
        </div>
        ${b.sections.length===0?`
  ...
  `}function He(){if(!f)return;const e=f.querySelector("#split-preview-content");e&&(e.innerHTML=it(),ot())}function ot(){var e,t,r,s;(e=document.getElementById("split-preview-close-btn"))==null||e.addEventListener("click",ne),(t=document.getElementById("split-preview-close-error"))==null||t.addEventListener("click",ne),(r=document.getElementById("split-preview-dismiss-btn"))==null||r.addEventListener("click",ne),(s=document.getElementById("split-preview-copy-btn"))==null||s.addEventListener("click",()=>{const n=`factbase organize split ${Z}`;navigator.clipboard.writeText(n).then(()=>{const a=document.getElementById("split-preview-copy-btn");a&&(a.textContent="Copied!",setTimeout(()=>{a.textContent="Copy Command"},2e3))}).catch(()=>{alert(`Run: ${n}`)})})}async function fr(e){b.loading=!0,b.error=null,b.doc=null,b.sections=[],He();try{const t=await k.getDocument(e);b.doc=t,t.content&&(b.sections=pr(t.content))}catch(t){t instanceof C?b.error=t.message:b.error="Failed to load document"}finally{b.loading=!1,He()}}function yr(e){Z=e,V||(vr(),V=!0),fr(e)}function ne(){f&&(f.classList.add("translate-x-full"),setTimeout(()=>{f==null||f.remove(),f=null},300)),V=!1,b.doc=null,b.sections=[],b.error=null,Z=null}function vr(){f==null||f.remove(),f=document.createElement("div"),f.id="split-preview-panel",f.className=`
    fixed top-0 right-0 h-full w-full sm:w-[480px] lg:w-[560px]
    bg-white dark:bg-gray-800 shadow-xl
    transform translate-x-full transition-transform duration-300 ease-in-out
    z-50 flex flex-col
